...
--
-- Servidor: localhost
-- Tiempo de generación: 10-04-2014 a las 06:33:33
...
INSERT INTO `estado_orden` (`idEstadoOrden`, `descripcion`, `estado`) VALUES
(1, 'Ingresada', b'1'),
(2, 'En Trabajo', b'1'),
(3, 'En Servicio Tercero', b'1'),
(4, 'En DyP', b'1'),
(5, 'Terminada', b'1'),
(6, 'Cancelada', b'1'),
(7, 'Eliminada', b'1');
...
CREATE TABLE IF NOT EXISTS `orden_trabajo_estado` (
  `idOrdenTrabajoEstado` int(11) NOT NULL,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=212 ;
...
(5, 6, 'TRA0001', 'Cambio de Pastillas', 13, 80000, b'1'),
(6, 7, 'TRA0002', 'Cambio Bujias', 6, 12000, b'1');
...
INSERT INTO `trabajo_sub_tipo` (`idTrabajoSubTipo`, `idTrabajoTipo`, `descripcion`, `estado`) VALUES
(6, 1, 'Mantención Frenos', b'1'),
(7, 1, 'Mantención Bujias', b'1');
...
ALTER TABLE `orden_trabajo_estado`
  ADD CONSTRAINT `fk_orden_trabajo_estado_estado_trabajo1` FOREIGN KEY (`idEstadoTrabajo`) REFERENCES `atm2`.`estado_trabajo` (`idEstadoTrabajo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_orden_trabajo_estado_orden_trabajo2` FOREIGN KEY (`idOrdenTrabajo`) REFERENCES `atm2`.`orden_trabajo` (`idOrdenTrabajo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
